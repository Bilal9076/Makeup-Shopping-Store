...
import * as UserSignUpAction from '../../Store/Action/AuthAction'
...
const StudentSignUpScreen = (props) => {
    ...
    const authHandler = async () => {
        ...
        SetisLoading(true)
        try {
            await dispatch(UserSignUpAction.CreateSignUpUser(
    ...
    return (
        <View style={styles.container}>
                ...
                <View style={styles.center_View}>
                    <View style={styles.warning_modal}>
                        ...
                        <View style={styles.warning_Message}>
                            <Text style={styles.text}>Please wait to Confrim your request by admin</Text>
                        </View>
                        <Pressable
                            onPress={() => {
                                setAlert(false)
            ...
            <AntDesign name="shoppingcart"  size={60} color="white" />
                    </View>
                <Text style={styles.text_header}>MakeUp Shopping Store</Text>
            </View>
            <View style={styles.footer}>
                {/* for email */}
                <View style={styles.txtContainer}>
                    <Text style={styles.valuetext}>Shopping Store</Text>
                    <Text style={styles.signText}>please sign up to continue</Text>
                </View>
                <Text style={styles.text_footer}>E-mail</Text>
                <View style={styles.action}>
                    {/* <AntDesign name="user" size={20} color="#C2185B" /> */}
                    <MaterialIcons name="email" size={20} color="#C2185B" />
                    <InputSign
                ...
                <TouchableOpacity
                onPress={()=>{
                    //  props.navigation.navigate('Customer Login')
                    authHandler() 
                    // setAlert(true)       
                }}
                    // onPress={authHandler}
